    ...
    if ($("#formTambah").length > 0) {
        $("#formTambah").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('modulakunting/pemasukan/simpan') ?>",
                    type: "POST",
    ...
    if ($("#formEdit").length > 0) {
        $("#formEdit").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('modulakunting/pemasukan/update') ?>",
                    type: "POST",
...
<script type="text/javascript">
    ...
    $('#show_data').on('click', '.item_edit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('modulakunting/pemasukan/tampil_byid') ?>",
            async: true,
            dataType: "JSON",
            data: {
                id: id,
    ...
    $('#show_data').on('click', '.item_hapus', function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('modulakunting/pemasukan/delete') ?>",
                    async: true,
                    dataType: "JSON",
                    data: {
                        id: id,
